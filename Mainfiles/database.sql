...
--
-- Database: `filmho_db`
--CREATE USER 'filmho'@'localhost' IDENTIFIED BY ';n@l&P<u6D64';
--  USE DATABASE filmoh_db;


--GRANT ALL PRIVILEGES ON filmo_db.* TO 'filmho'@'localhost';

--GRANT ALL PRIVILEGES ON *.* TO 'filmho'@'localhost';
---CREATE USER 'filmho'@'localhost' IDENTIFIED BY ';n@l&P<u6D64'; 
...
INSERT INTO `admin` (`id`, `user_name`, `email`, `password`, `type`, `status`) VALUES
(2, 'admin', 'luis@admin.com', '$2y$12$1KrR/kdY11GBmdeJdHEGXugNaviCQNO.SygwNhV7xBq9PAweVEf3y', 1, 1);
